...
<?php include("../include/header(sandwich).php"); ?>
            ...
            <div class="column">
              <div class="content">
                <img src="../images/food/sandwich1.jpg" class="images" alt="Food" style="width: 100%;">
                    ...
                    <h4>LKR 400.00</h4><br>
                    <button class="order-btn" name ="Order_btn4a" type ="submit"><b>Order now</b></button>
              </div>
            </div>

            <div class="column">
                <div class="content">
                    <img src="../images/food/sandwich2.jpg" class="images" alt="Food" style="width: 100%;">
                    <h3>The Food Factory</h3>
                    <h4>LKR 500.00</h4><br>
                    <button class="order-btn" name ="Order_btn4b" type ="submit"><b>Order now</b></button>
                </div>
            </div>

            <div class="column">
                <div class="content">
                    <img src="../images/food/sandwich5.jpg" class="images" alt="Food" style="width: 100%;">
                    <h3>Restaurant FoodStuff</h3>
                    <h4>LKR 600.00</h4><br>
                    <button class="order-btn" name ="Order_btn4c" type ="submit"><b>Order now</b></button>
                </div>
            </div>
