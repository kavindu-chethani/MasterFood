...
<?php include("../include/header(pizza).php"); ?>
            ...
            <div class="column">
              <div class="content">
                <img src="../images/food/pizza4.jpg" class="images" alt="Food" style="width: 100%;">
                    ...
                    <h4>LKR 800.00</h4><br>
                    <button class="order-btn" name ="Order_btn5a" type ="submit"><b>Order now</b></button>
              </div>
            </div>

            <div class="column">
                <div class="content">
                    <img src="../images/food/pizza5.jpg" class="images" alt="Food" style="width: 100%;">
                    <h3>The Food Factory</h3>
                    <h4>LKR 900.00</h4><br>
                    <button class="order-btn" name ="Order_btn5b" type ="submit"><b>Order now</b></button>
                </div>
            </div>

            <div class="column">
                <div class="content">
                    <img src="../images/food/pizza7.jpg" class="images" alt="Food" style="width: 100%;">
                    <h3>Restaurant FoodStuff</h3>
                    <h4>LKR 1200.00</h4><br>
                    <button class="order-btn" name ="Order_btn5c" type ="submit"><b>Order now</b></button>
                </div>
            </div>
