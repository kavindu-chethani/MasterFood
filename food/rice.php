...
<?php include("../include/header(rice).php"); ?>
    ...
    <div class= "main-content">
     <form action = "../config/cat_load.php" method = "post">
        <div class="row">
            <div class="column">
              <div class="content">
                <img src="../images/food/rice2.jpg" class="images" alt="Food" style="width: 100%;">
                    <h3>MIHIRI Restaurant</h3>
                    <h4>LKR 400.00</h4><br>
                    <button id="1" class="order-btn" name ="Order_btn1a" type ="submit"><b>Order now</b></button>
              </div>
            </div>

            <div class="column">
                <div class="content">
                    <img src="../images/food/rice4.jpg" class="images" alt="Food" style="width: 100%;">
                    <h3>The Food Factory</h3>
                    <h4>LKR 500.00</h4><br>
                    <button id="2" class="order-btn" name ="Order_btn1b" type ="submit"><b>Order now</b></button>
                </div>
            </div>

            <div class="column">
                <div class="content">
                    <img src="../images/food/rice6.jpg" class="images" alt="Food" style="width: 100%;">
                    <h3>Restaurant FoodStuff</h3>
                    <h4>LKR 600.00</h4><br>
                    <button id="3" class="order-btn" name ="Order_btn1c" type ="submit"><b>Order now</b></button>
                </div>
            </div>
            ...
            <div class="column">
                <div class="content">
                    ...
                    <h3>Restaurant Homey Meals</h3>
                    <h4>LKR 800.00</h4><br>
                    <button id="4" class="order-btn" name ="Order_btn1d" type ="submit"><b>Order now</b></button>
                </div>
            </div>
