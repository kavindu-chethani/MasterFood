...
<?php include("../include/header(burger).php"); ?>
    ...
    <form action = "../config/cat_load.php" method = "post">
        <div class="row">
            <div class="column">
              <div class="content">
                <img src="../images/food/burger9.jpg" class="images" alt="Food" style="width: 100%;">
                    <h3>MIHIRI Restaurant</h3>
                    <h4>LKR 400.00</h4><br>
                    <button class="order-btn" name ="Order_btn6a" type ="submit"><b>Order now</b></button>
              </div>
            </div>
            ...
            <div class="column">
                <div class="content">
                    <img src="../images/food/burger5.jpg" class="images" alt="Food" style="width: 100%;">
                    <h3>The Food Factory</h3>
                    <h4>LKR 500.00</h4><br>
                        <button class="order-btn" name ="Order_btn6b" type ="submit"><b>Order now</b></button>
                </div>
            </div>

            <div class="column">
                <div class="content">
                    <img src="../images/food/burger6.jpg" class="images" alt="Food" style="width: 100%;">
                    <h3>Restaurant FoodStuff</h3>
                    <h4>LKR 600.00</h4><br>
                        <button class="order-btn" name ="Order_btn6c" type ="submit"><b>Order now</b></button>
                </div>
            </div>
