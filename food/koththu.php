...
<?php include("../include/header(koththu).php"); ?>
    ...
    <form action = "../config/cat_load.php" method = "post">
        <div class="row">
            <div class="column">
              <div class="content">
                <img src="../images/food/koththu1.png" class="images" alt="Food" style="width: 100%;">
                    <h3>MIHIRI Restaurant</h3>
                    <h4>LKR 400.00</h4><br>
                    <button class="order-btn" name ="Order_btn2a" type ="submit"><b>Order now</b></button>
              </div>
            </div>

            <div class="column">
                <div class="content">
                    <img src="../images/food/koththu4.jpg" class="images" alt="Food" style="width: 100%;">
                    <h3>The Food Factory</h3>
                    <h4>LKR 500.00</h4><br>
                    <button class="order-btn" name ="Order_btn2b" type ="submit"><b>Order now</b></button>
                </div>
            </div>
            ...
            <div class="column">
                <div class="content">
                    ...
                    <h4>LKR 600.00</h4><br>
                    <button class="order-btn" name ="Order_btn2c" type ="submit"><b>Order now</b></button>
                </div>
            </div>
